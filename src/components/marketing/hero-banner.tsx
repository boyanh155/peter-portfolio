  ...
  return (
    <div className="w-full relative overflow-hidden py-[calc(2*var(--header-height))]">
      ...
      <div className="flex flex-col justify-center items-center">
        {/* Big words */}
        <h2 className="big_word_name  border-dash-top border-dash-bottom py-8 w-full">
          Peter Le - A Software Engineer
          <div className=" border-dash-left" />
          <div className="border-dash-right" />
        </h2>
        {/* Content */}
        <h4 className="text-[1.8vw] relative text-zinc-500 text-center light border-dash-bottom w-full py-6 leading-12">
          <div className=" border-dash-left" />
          <div className="border-dash-right" />
        ...
        <div className="flex flex-col relative gap-4 py-6 border-dash-bottom w-full justify-center items-center">
          <div className=" border-dash-left" />
          <div className="border-dash-right" />
